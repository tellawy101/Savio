...
income_title: "Income",
    ...
    login_prompt_desc: "Keep your data backed up and synced safely on the cloud.",
    login_prompt_signin: "Sign in",
    login_prompt_signup: "Create account",
    login_prompt_skip: "Skip for now",
        ...
        settings_about_savio: "About Savio",
        settings_about_savio_desc: "Learn more about the app",
        settings_about_savio_text: "Savio is an app to easily manage your daily expenses and income, and track your budget at a glance.",
        settings_privacy: "Privacy",
        settings_privacy_desc: "Your data stays on your device",
        settings_privacy_text: "Your data is stored only on your device and never sent to any server.",
        settings_privacy_point1_label: "Storage",
        settings_privacy_point1_value: "On your device only",
        settings_privacy_point2_label: "Internet",
        settings_privacy_point2_value: "Not required",
        settings_privacy_point3_label: "Sharing",
        settings_privacy_point3_value: "Nothing is shared",
    ...
    settings_import_manual_desc: "Choose the backup file you saved earlier.",
    settings_import_choose_file: "Tap to choose your backup file",
...
enter_person_name_alert: "من فضلك اكتب اسم الشخص",
    ...
    login_prompt_title: "تسجيل الدخول",
    login_prompt_desc: "احفظ بياناتك ومعاملاتك بشكل آمن على السحابة ووصلها بأي جهاز.",
    login_prompt_signin: "تسجيل الدخول",
    login_prompt_signup: "إنشاء حساب",
    login_prompt_skip: "تخطي الآن",
        ...
        settings_about_savio: "عن Savio",
        settings_about_savio_desc: "اعرف أكتر عن التطبيق",
        settings_about_savio_text: "Savio هو تطبيق لإدارة مصاريفك ودخلك اليومي بسهولة، ومتابعة ميزانيتك أول بأول.",
        settings_privacy: "الخصوصية",
        settings_privacy_desc: "بياناتك تفضل على جهازك بس",
        settings_privacy_text: "بياناتك متخزنة على جهازك بس، ومفيش أي حاجة بتترسل لأي سيرفر.",
        settings_privacy_point1_label: "التخزين",
        settings_privacy_point1_value: "على جهازك بس",
        settings_privacy_point2_label: "الإنترنت",
        settings_privacy_point2_value: "مش مطلوب",
        settings_privacy_point3_label: "المشاركة",
        settings_privacy_point3_value: "مفيش حاجة بتتشارك",
    ...
    settings_import_manual_desc: "اختار ملف النسخة الاحتياطية اللي حفظته قبل كده.",
    settings_import_choose_file: "دوس عشان تختار ملف النسخة الاحتياطية",
